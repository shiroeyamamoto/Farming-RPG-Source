...
[CustomPropertyDrawer(typeof(ItemCodeDecriptionAttribute))]
public class ItemCodeDecriptionDrawer : PropertyDrawer
{
    ...
    private string GetItemDescription(int itemCode)
    {
        ...
        // so_itemList ở đây là rỗng, vì thế cần vào Asset để lấy file so_itemList đã tạo trong đó và truyền vào đây
        ...
        ItemDetails itemDetails = itemList.Find(x => x.itemCode == itemCode);
